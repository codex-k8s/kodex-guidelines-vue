...
## Auth и доступы
- Вход в UI соответствует выбранной проектной auth/SSO схеме
  (например, GitHub OAuth, Google OAuth, corporate SSO).
...
- Перед пушем выполнена повторная сверка с релевантными чек-листами проекта и текущего репозитория; нарушения по размещению типов/моделей/констант/helper-кода устранены.
