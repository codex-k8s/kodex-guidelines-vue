...
- Перед пушем выполнена повторная сверка с `github.com/codex-k8s/kodex-guidelines-common-ru/check_list.md` и текущим файлом; нарушения по размещению типов/моделей/констант/helper-кода устранены.
